using Basirah.Application;
using Basirah.Infrastructure;
using Basirah.Presentation.Extensions;
using Basirah.Presentation.Middleware;
using Serilog;
...
// Run
// ============================================
Log.Information("Starting Basirah API...");
